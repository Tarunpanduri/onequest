...
// // Ensures foreground notifications are displayed
// Notifications.setNotificationHandler({
//   handleNotification: async () => ({
//     shouldShowAlert: true, // Allows notifications to be shown when the app is open
...
//   // Function to save push tokens under dynamic keys like user1, user2, etc.
//   const savePushTokenToDatabase = async (token) => {
//     const tokenRef = ref(database, `NotificationTokens`);

//     // Check if the token already exists to avoid duplicates
//     const snapshot = await get(tokenRef);
//     const tokensList = snapshot.val() || {};

//     const tokenExists = Object.values(tokensList).some((t) => t === token);

//     if (tokenExists) {
//       console.log('Token already exists in Firebase');
//       return;
//     }

//     // Push new token under an auto-generated key (user1, user2, etc.)
//     push(tokenRef, token)
